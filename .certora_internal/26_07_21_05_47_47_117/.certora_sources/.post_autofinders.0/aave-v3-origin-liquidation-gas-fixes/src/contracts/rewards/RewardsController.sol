...
contract RewardsController is RewardsDistributor, VersionedInitializable, IRewardsController {
  ...
  function configureAssets(
    ...
    for (uint256 i; i < config.length; i++) {
      ...
      config[i].totalSupply = IScaledBalanceToken(config[i].asset).scaledTotalSupply();uint256 certora_local21 = config[i].totalSupply;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000015,certora_local21)}
  ...
  function claimAllRewards(
    ...
    require(to != address(0), 'INVALID_TO_ADDRESS');
    (rewardsList, claimedAmounts) = _claimAllRewards(assets, msg.sender, msg.sender, to);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002000e,0)}
  }
    ...
    returns (address[] memory rewardsList, uint256[] memory claimedAmounts)
  {
    require(user != address(0), 'INVALID_USER_ADDRESS');
    require(to != address(0), 'INVALID_TO_ADDRESS');
    (rewardsList, claimedAmounts) = _claimAllRewards(assets, msg.sender, user, to);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002000f,0)}
  }
  ...
  function claimAllRewardsToSelf(
    ...
    (rewardsList, claimedAmounts) = _claimAllRewards(assets, msg.sender, msg.sender, msg.sender);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020010,0)}
  }
  ...
  function _getUserAssetBalances(
    ...
    for (uint256 i; i < assets.length; i++) {
      userAssetBalances[i].asset = assets[i];address certora_local22 = userAssetBalances[i].asset;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000016,certora_local22)}
      (userAssetBalances[i].userBalance, userAssetBalances[i].totalSupply) = IScaledBalanceToken(
        assets[i]
      ).getScaledUserBalanceAndSupply(user);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020017,0)}
    }
  }
  ...
  function _claimRewards(
    ...
    if (amount != 0) {
      ...
      for (uint256 i; i < assets.length; i++) {
        ...
        totalRewards += _assets[asset].rewards[reward].usersData[user].accrued;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001a,totalRewards)}

        if (totalRewards <= amount) {
          _assets[asset].rewards[reward].usersData[user].accrued = 0;
        } else {
          uint256 difference = totalRewards - amount;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001b,difference)}
  ...
  function _claimAllRewards(
    ...
    uint256 rewardsListLength = _rewardsList.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000a,rewardsListLength)}
  ...
  function _transferRewards(address to, address reward, uint256 amount) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110000, 1037618708497) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00111000, to) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00111001, reward) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00111002, amount) }
    ITransferStrategyBase transferStrategy = _transferStrategy[reward];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000b,0)}

    bool success = transferStrategy.performTransfer(to, reward, amount);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,success)}
  ...
  function _isContract(address account) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00140000, 1037618708500) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00140001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00141000, account) }
    ...
    uint256 size;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,size)}
