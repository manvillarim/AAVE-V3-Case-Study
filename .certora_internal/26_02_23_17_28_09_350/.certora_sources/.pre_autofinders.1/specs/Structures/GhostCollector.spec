...
hook Sstore a.(slot 0x9b779b17422d0df92223018b32b4d1fa46e071723d6817e2486d003becc55f00) uint256 newValue {
    ghost_a_reentrancyStatus = newValue;
}

hook Sload uint256 val a.(slot 0x9b779b17422d0df92223018b32b4d1fa46e071723d6817e2486d003becc55f00) {
    require ghost_a_reentrancyStatus == val;
}

hook Sstore ao.(slot 0x9b779b17422d0df92223018b32b4d1fa46e071723d6817e2486d003becc55f00) uint256 newValue {
    ghost_ao_reentrancyStatus = newValue;
}

hook Sload uint256 val ao.(slot 0x9b779b17422d0df92223018b32b4d1fa46e071723d6817e2486d003becc55f00) {
    require ghost_ao_reentrancyStatus == val;
}

hook Sstore a.(slot 0x02dd7bc7dec4dceedda775e58dd541e08a116c6c53815c0bd028192f7b626800)[KEY bytes32 role][KEY address account] bool newValue (bool oldValue) {
    ghost_a_roles[role][account] = newValue;
}

hook Sload bool val a.(slot 0x02dd7bc7dec4dceedda775e58dd541e08a116c6c53815c0bd028192f7b626800)[KEY bytes32 role][KEY address account] {
    require ghost_a_roles[role][account] == val;
}

hook Sstore ao.(slot 0x02dd7bc7dec4dceedda775e58dd541e08a116c6c53815c0bd028192f7b626800)[KEY bytes32 role][KEY address account] bool newValue (bool oldValue) {
    ghost_ao_roles[role][account] = newValue;
}

hook Sload bool val ao.(slot 0x02dd7bc7dec4dceedda775e58dd541e08a116c6c53815c0bd028192f7b626800)[KEY bytes32 role][KEY address account] {
    require ghost_ao_roles[role][account] == val;
}

hook Sstore a.(slot 0x02dd7bc7dec4dceedda775e58dd541e08a116c6c53815c0bd028192f7b626800)[KEY bytes32 role].(offset 32) bytes32 newValue (bytes32 oldValue) {
    ghost_a_roleAdmin[role] = newValue;
}

hook Sload bytes32 val a.(slot 0x02dd7bc7dec4dceedda775e58dd541e08a116c6c53815c0bd028192f7b626800)[KEY bytes32 role].(offset 32) {
    require ghost_a_roleAdmin[role] == val;
}

hook Sstore ao.(slot 0x02dd7bc7dec4dceedda775e58dd541e08a116c6c53815c0bd028192f7b626800)[KEY bytes32 role].(offset 32) bytes32 newValue (bytes32 oldValue) {
    ghost_ao_roleAdmin[role] = newValue;
}

hook Sload bytes32 val ao.(slot 0x02dd7bc7dec4dceedda775e58dd541e08a116c6c53815c0bd028192f7b626800)[KEY bytes32 role].(offset 32) {
    require ghost_ao_roleAdmin[role] == val;
}