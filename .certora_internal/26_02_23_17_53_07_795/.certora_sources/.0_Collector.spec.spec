...
methods {
    ...
    function ERC20Mock.transfer(address, uint256) external => ghostTransferSuccess[calledContract] expect bool;
    function _.transfer(address, uint256) external => ghostTransferSuccess[calledContract] expect bool;

    function ERC20Mock.transferFrom(address, address, uint256) external => ghostTransferFromSuccess[calledContract] expect bool ALL;
