...
definition couplingInv() returns bool =
    ...
    (forall uint256 streamId.
        ...
        (forall uint256 streamId.
        !ghost_a_streams_isEntity[streamId] => (
            ghost_a_streams_remainingBalance[streamId] == 0 &&
            ghost_a_streams_deposit[streamId] == 0 &&
            ghost_a_streams_ratePerSecond[streamId] == 0 &&
            ghost_a_streams_startTime[streamId] == 0 &&
            ghost_a_streams_stopTime[streamId] == 0 &&
            ghost_a_streams_sender[streamId] == 0 &&
            ghost_a_streams_recipient[streamId] == 0 &&
            ghost_a_streams_tokenAddress[streamId] == 0
        )
    ) &&

    (forall uint256 streamId.
        !ghost_ao_streams_isEntity[streamId] => (
            ghost_ao_streams_remainingBalance[streamId] == 0 &&
            ghost_ao_streams_deposit[streamId] == 0 &&
            ghost_ao_streams_ratePerSecond[streamId] == 0 &&
            ghost_ao_streams_startTime[streamId] == 0 &&
            ghost_ao_streams_stopTime[streamId] == 0 &&
            ghost_ao_streams_sender[streamId] == 0 &&
            ghost_ao_streams_recipient[streamId] == 0 &&
            ghost_ao_streams_tokenAddress[streamId] == 0
        )
    );
