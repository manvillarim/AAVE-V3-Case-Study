...
rule gasOptimizedCorrectnessOfCreateStream {
    env eA;
    env eAo;
    address recipient;
    uint256 deposit;
    ...
    require eA == eAo && couplingInv();
    require recipient != a && recipient != ao;

    a.createStream@withrevert(eA, recipient, deposit, tokenAddress, startTime, stopTime);
    bool a_reverted = lastReverted;

    ao.createStream@withrevert(eAo, recipient, deposit, tokenAddress, startTime, stopTime);
    bool ao_reverted = lastReverted;
