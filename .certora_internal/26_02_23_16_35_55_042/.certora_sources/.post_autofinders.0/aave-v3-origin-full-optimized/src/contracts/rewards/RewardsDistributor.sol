...
abstract contract RewardsDistributor is IRewardsDistributor {
  ...
  function getRewardsByAsset(
    ...
    for (uint128 i; i < rewardsCount; ) {
      availableRewards[i] = _assets[asset].availableRewards[i];address certora_local73 = availableRewards[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000049,certora_local73)}
  ...
  function getUserAccruedRewards(
    ...
    for (uint256 i; i < assetsListLength; ) {
      totalAccrued += _assets[_assetsList[i]].rewards[reward].usersData[user].accrued;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004a,totalAccrued)}
    ...
    returns (address[] memory rewardsList, uint256[] memory unclaimedAmounts)
  {
    ...
    for (uint256 i; i < userAssetBalancesLength; ) {
      ...
      RewardsDataTypes.UserAssetBalance memory userAssetBalance = userAssetBalances[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001003a,0)}
      for (uint256 r; r < rewardsListLength; ) {
        rewardsList[r] = _rewardsList[r];address certora_local78 = rewardsList[r];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004e,certora_local78)}
        unclaimedAmounts[r] += _assets[userAssetBalance.asset]
          .rewards[rewardsList[r]]
          .usersData[user]
          .accrued;uint256 certora_local79 = unclaimedAmounts[r];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004f,certora_local79)}
        ...
        unclaimedAmounts[r] += _getPendingRewards(user, rewardsList[r], userAssetBalance);uint256 certora_local80 = unclaimedAmounts[r];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000050,certora_local80)}
        // RULE 28 - Unchecked arithmetic: r < rewardsListLength guarantees no overflow
        unchecked { ++r; }
      }
  ...
  function setEmissionPerSecond(
    ...
    for (uint256 i; i < rewardsLength; ) {
      RewardsDataTypes.AssetData storage assetConfig = _assets[asset];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001003b,0)}
      RewardsDataTypes.RewardData storage rewardConfig = assetConfig.rewards[rewards[i]];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001003c,0)}
      uint256 decimals = assetConfig.decimals;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003d,decimals)}
      // RULE 1 - Replace require with custom errors
      ...
      uint256 oldEmissionPerSecond = rewardConfig.emissionPerSecond;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003f,oldEmissionPerSecond)}
      rewardConfig.emissionPerSecond = newEmissionsPerSecond[i];uint88 certora_local75 = rewardConfig.emissionPerSecond;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004b,certora_local75)}

      uint32 distributionEnd = rewardConfig.distributionEnd;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000040,distributionEnd)}
  ...
  function _configureAssets(RewardsDataTypes.RewardsConfigInput[] memory rewardsInput) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170000, 1037618708503) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171000, rewardsInput) }
    ...
    for (uint256 i; i < rewardsInputLength; ) {
      ...
      RewardsDataTypes.RewardsConfigInput memory input = rewardsInput[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010041,0)}

      if (_assets[input.asset].decimals == 0) {
        _assetsList.push(input.asset);
      }

      uint256 decimals = _assets[input.asset].decimals = IERC20Detailed(input.asset).decimals();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000042,decimals)}

      RewardsDataTypes.RewardData storage rewardConfig = _assets[input.asset].rewards[input.reward];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010043,0)}
      ...
      uint88 oldEmissionsPerSecond = rewardConfig.emissionPerSecond;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000045,oldEmissionsPerSecond)}
      uint32 oldDistributionEnd = rewardConfig.distributionEnd;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000046,oldDistributionEnd)}
      rewardConfig.emissionPerSecond = input.emissionPerSecond;uint88 certora_local76 = rewardConfig.emissionPerSecond;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004c,certora_local76)}
      rewardConfig.distributionEnd = input.distributionEnd;uint32 certora_local77 = rewardConfig.distributionEnd;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004d,certora_local77)}
    ...
    if (numAvailableRewards != 0) {
      unchecked {
        ...
        for (uint128 r; r < numAvailableRewards; r++) {
          address reward = _assets[asset].availableRewards[r];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000051,reward)}
          RewardsDataTypes.RewardData storage rewardData = _assets[asset].rewards[reward];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010052,0)}

          (uint256 newAssetIndex, bool rewardDataUpdated) = _updateRewardData(
            rewardData,
            totalSupply,
            assetUnit
          );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010053,0)}
  ...
  function _updateDataMultiple(
    ...
    for (uint256 i; i < userAssetBalancesLength; ) {
      // RULE 24 - Cache array member variable
      RewardsDataTypes.UserAssetBalance memory bal = userAssetBalances[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010047,0)}
  ...
  function _getUserReward(
    ...
    for (uint256 i; i < userAssetBalancesLength; ) {
      // RULE 24 - Cache array member variable
      RewardsDataTypes.UserAssetBalance memory bal = userAssetBalances[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010048,0)}
      if (bal.userBalance == 0) {
        ...
        unclaimedRewards +=
          ...
          _assets[bal.asset].rewards[reward].usersData[user].accrued;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000055,unclaimedRewards)}
      }
      // RULE 28 - Unchecked arithmetic: i < userAssetBalancesLength guarantees no overflow
      unchecked { ++i; }
    }
